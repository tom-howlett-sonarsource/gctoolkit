...
import com.microsoft.gctoolkit.io.util.GCLogSource;
...
public class SafepointLogFile implements DataSource<String> {
    ...
    public Stream<String> stream() throws IOException {
        return GCLogSource.discover(path).lines();
    }

    Stream<String> streamZipFile() throws IOException {
        return GCLogSource.open(path, GCLogSource.Format.ZIP);
    }

    Stream<String> streamGZipFile() throws IOException {
        return GCLogSource.open(path, GCLogSource.Format.GZIP);
    }
