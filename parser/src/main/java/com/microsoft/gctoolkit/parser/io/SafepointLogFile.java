...
import com.microsoft.gctoolkit.logsource.LogSourceMetadata;
...
public class SafepointLogFile implements DataSource<String> {
    ...
    /**
     * Safepoint sources do not contribute diary metadata.
     * @return a diary
     */
    public Diary diary() {
        return new Diary();
    ...
    public Stream<String> stream() throws IOException {
        return LogSourceStreams.stream(new LogSourceMetadata(path));
    }
