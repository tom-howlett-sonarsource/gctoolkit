...
public class SingleGCLogFile extends GCLogFile {
    ...
    private static Stream<String> streamZipFile(Path path) throws IOException {
        ...
        try {
            ...
            return ResourceBackedStreams.lines(new BufferedReader(new InputStreamReader(new BufferedInputStream(zipStream))));
        } catch (IOException | RuntimeException exception) {
            ResourceBackedStreams.closeAfterFailure(zipStream, exception);
            throw exception;
        }
    }
    ...
    private static Stream<String> streamGZipFile(Path path) throws IOException {
        ...
        try {
            ...
            return ResourceBackedStreams.lines(new BufferedReader(new InputStreamReader(new BufferedInputStream(gzipStream))));
        } catch (IOException | RuntimeException exception) {
            ResourceBackedStreams.closeAfterFailure(inputStream, exception);
            throw exception;
        }
    }
