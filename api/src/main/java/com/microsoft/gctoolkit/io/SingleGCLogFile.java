...
public class SingleGCLogFile extends GCLogFile {
    ...
    private static Stream<String> streamZipFile(Path path) throws IOException {
        ...
        try {
            ...
            return closeableLines(reader, zipStream);
    ...
    private static Stream<String> streamGZipFile(Path path) throws IOException {
        ...
        return closeableLines(reader, gzipStream);
    }

    private static Stream<String> closeableLines(BufferedReader reader, Closeable archiveStream) {
        return reader.lines().onClose(() -> close(reader, archiveStream));
    }
