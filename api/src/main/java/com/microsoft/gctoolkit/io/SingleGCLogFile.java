...
public class SingleGCLogFile extends GCLogFile {
    ...
    private static Stream<String> streamZipFile(Path path) throws IOException {
        ...
        try {
            ...
            return closeWithStream(new BufferedReader(new InputStreamReader(new BufferedInputStream(zipStream))));
    ...
    private static Stream<String> streamGZipFile(Path path) throws IOException {
        ...
        return closeWithStream(new BufferedReader(new InputStreamReader(new BufferedInputStream(gzipStream))));
    }

    private static Stream<String> closeWithStream(BufferedReader reader) {
