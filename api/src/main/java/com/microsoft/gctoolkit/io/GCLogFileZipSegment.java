...
public class GCLogFileZipSegment implements LogFileSegment {
     ...
     */
    @SuppressWarnings("resource") // the archive and reader are closed via the returned stream's onClose handler
    ...
    private static void closeQuietly(Closeable closeable) {
        ...
        try {
            ...
            // best effort close after an already-reported failure
        }
    }
