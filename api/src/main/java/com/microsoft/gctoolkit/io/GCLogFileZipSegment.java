...
public class GCLogFileZipSegment implements LogFileSegment {
    ...
    public Stream<String> stream() {
        ...
        try {
            ...
            final ZipFile archive = file;
            // The archive holds a file descriptor for as long as the stream is readable, so it is
            // released when the stream is closed rather than when the stream is exhausted. That way a
            // caller who closes a partially consumed stream does not leak the archive.
