...
import com.microsoft.gctoolkit.gclogsource.TailLines;
...
public class GCLogFileZipSegment implements LogFileSegment {
    ...
    private void close(BufferedReader reader, ZipFile file) {
        try {
            reader.close();
