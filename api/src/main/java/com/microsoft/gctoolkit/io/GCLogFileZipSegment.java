...
public class GCLogFileZipSegment implements LogFileSegment {
     ...
     */
    // The ZipFile and reader must outlive this method: they are only closed when the
    // caller closes the returned Stream, via the onClose handler below.
    ...
    public Stream<String> stream() {
        try {
            ...
            return reader.lines().onClose(() -> CloseableResources.closeAll(reader, file));
        } catch (IOException e) {
