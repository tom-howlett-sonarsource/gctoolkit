...
public abstract class LogFileMetadata {
    ...
    public boolean isZip()  {
        return source.getFormat() == LogFileSource.Format.ZIP;
    }
    ...
    public boolean isGZip() {
        return source.getFormat() == LogFileSource.Format.GZIP;
    }
    ...
    public boolean isPlainText() {
        return source.getFormat() == LogFileSource.Format.PLAIN_TEXT;
    }
    ...
    public boolean isDirectory() {
        return source.getFormat() == LogFileSource.Format.DIRECTORY;
    }
