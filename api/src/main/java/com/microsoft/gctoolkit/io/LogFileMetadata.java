...
public abstract class LogFileMetadata {
    ...
    public LogFileMetadata(Path path) throws IOException {
        this.path = path;
        this.fileFormat = LogFileFormat.detect(path);
    }
    ...
    /**
     * The format in which the log file is held.
     * @return The format in which the log file is held.
     */
    public LogFileFormat getFileFormat() {
        return fileFormat;
    }
