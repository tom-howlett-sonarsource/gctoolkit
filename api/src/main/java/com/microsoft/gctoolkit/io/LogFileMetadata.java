...
public abstract class LogFileMetadata {
    ...
    public boolean isZip()  {
        return source.type() == GCLogSource.Type.ZIP;
    }
    ...
    public boolean isGZip() {
        return source.type() == GCLogSource.Type.GZIP;
    }
    ...
    public boolean isPlainText() {
        return source.type() == GCLogSource.Type.PLAIN_TEXT;
    }
    ...
    public boolean isDirectory() {
        return source.type() == GCLogSource.Type.DIRECTORY;
    }
