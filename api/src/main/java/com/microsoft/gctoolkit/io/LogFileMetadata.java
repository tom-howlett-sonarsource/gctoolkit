...
public abstract class LogFileMetadata {
    ...
    public LogFileMetadata(Path path) throws IOException {
        this.path = path;
        this.source = GCLogSource.discover(path);
    }
    ...
    public boolean isZip()  {
        return source.getFormat() == GCLogSource.Format.ZIP;
    }
    ...
    public boolean isGZip() {
        return source.getFormat() == GCLogSource.Format.GZIP;
    }
    ...
    public boolean isPlainText() {
        return source.getFormat() == GCLogSource.Format.PLAIN_TEXT;
    }
    ...
    public boolean isDirectory() {
        return source.getFormat() == GCLogSource.Format.DIRECTORY;
    }
