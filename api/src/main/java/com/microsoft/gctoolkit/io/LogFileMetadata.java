...
public abstract class LogFileMetadata {
    ...
    private final LogStreamFormat fileFormat;
    private final Path path;

    protected LogFileMetadata(Path path) throws IOException {
        this.path = path;
        this.fileFormat = MagicBytes.detectFormat(path);
    }
    ...
    public boolean isZip()  {
        return fileFormat == LogStreamFormat.ZIP;
    }
    ...
    public boolean isGZip() {
        return fileFormat == LogStreamFormat.GZIP;
    }
    ...
    public boolean isPlainText() {
        return fileFormat == LogStreamFormat.PLAINTEXT;
    }
    ...
    public boolean isDirectory() {
        return fileFormat == LogStreamFormat.DIRECTORY;
    }

    /**
     * Return the underlying format classification.
     * @return the detected {@link LogStreamFormat} for this source.
     */
    LogStreamFormat getFormat() {
        return fileFormat;
    }
}
