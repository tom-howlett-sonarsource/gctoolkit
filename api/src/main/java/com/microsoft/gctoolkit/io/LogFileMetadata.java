...
public abstract class LogFileMetadata {
    ...
    private final LogSource.Format fileFormat;
    private final Path path;

    public LogFileMetadata(Path path) throws IOException {
        this.path = path;
        fileFormat = LogSource.discover(path);
    }
    ...
    public boolean isZip()  {
        return fileFormat == LogSource.Format.ZIP;
    }
    ...
    public boolean isGZip() {
        return fileFormat == LogSource.Format.GZIP;
    }
    ...
    public boolean isPlainText() {
        return fileFormat == LogSource.Format.PLAIN_TEXT;
    }
    ...
    public boolean isDirectory() {
        return fileFormat == LogSource.Format.DIRECTORY;
    }
