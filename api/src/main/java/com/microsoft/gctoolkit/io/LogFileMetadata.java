...
public abstract class LogFileMetadata {
    ...
    public LogFileMetadata(Path path) throws IOException {
        this.path = path;
        this.fileFormat = GCLogSources.formatOf(path);
    }
    ...
    /**
     * Return the format of the log file, as discovered from the leading bytes of the file.
