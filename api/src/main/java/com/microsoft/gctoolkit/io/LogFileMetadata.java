...
public abstract class LogFileMetadata {
    ...
    private final LogSources.FileFormat fileFormat;
    ...
    public boolean isZip()  {
        return fileFormat == LogSources.FileFormat.ZIP;
    }
    ...
    public boolean isGZip() {
        return fileFormat == LogSources.FileFormat.GZIP;
    }
    ...
    public boolean isPlainText() {
        return fileFormat == LogSources.FileFormat.PLAINTEXT;
    }
    ...
    public boolean isDirectory() {
        return fileFormat == LogSources.FileFormat.DIRECTORY;
    }
