...
public abstract class LogFileMetadata {
    ...
    public LogFileMetadata(Path path) throws IOException {
        this.path = path;
        this.fileFormat = LogFileFormat.of(path);
    }
    ...
    /**
     * Return the size, in bytes, of the file. The size of a directory is the sum of the sizes
     * of the files it contains.
     * @return The size of the file, in bytes.
     */
    public long getSizeInBytes() {
        return LogFileSources.byteSize(path);
    }
