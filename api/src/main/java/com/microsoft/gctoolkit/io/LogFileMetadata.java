...
import com.microsoft.gctoolkit.io.support.LogFileFormat;
import com.microsoft.gctoolkit.io.support.LogFileFormats;
...
public abstract class LogFileMetadata {
    ...
    protected LogFileMetadata(Path path) throws IOException {
        this.path = path;
        this.fileFormat = LogFileFormats.detect(path);
    }
