...
import com.microsoft.gctoolkit.io.support.SourceFormat;
...
public abstract class LogFileMetadata {
    ...
    private SourceFormat sourceFormat = SourceFormat.UNKNOWN;
    private final Path path;

    protected LogFileMetadata(Path path) throws IOException {
        this.path = path;
        this.sourceFormat = GCLogSources.detect(path);
    }
    ...
    public boolean isZip()  {
        return sourceFormat == SourceFormat.ZIP;
    }
    ...
    public boolean isGZip() {
        return sourceFormat == SourceFormat.GZIP;
    }
    ...
    public boolean isPlainText() {
        return sourceFormat == SourceFormat.PLAINTEXT;
    }
    ...
    public boolean isDirectory() {
        return sourceFormat == SourceFormat.DIRECTORY;
    }
