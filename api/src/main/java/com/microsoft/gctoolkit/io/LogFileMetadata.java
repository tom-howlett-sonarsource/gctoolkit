...
public abstract class LogFileMetadata {
    ...
    private final LogFileSource.Format fileFormat;

    public LogFileMetadata(Path path) throws IOException {
        source = new LogFileSource(path);
    ...
    /**
     * Return the physical size of this source. For compressed sources this is the
    ...
    public boolean isZip()  {
        return fileFormat == LogFileSource.Format.ZIP;
    }
    ...
    public boolean isGZip() {
        return fileFormat == LogFileSource.Format.GZIP;
    }
    ...
    public boolean isPlainText() {
        return fileFormat == LogFileSource.Format.PLAIN_TEXT;
    }
    ...
    public boolean isDirectory() {
        return fileFormat == LogFileSource.Format.DIRECTORY;
    }
