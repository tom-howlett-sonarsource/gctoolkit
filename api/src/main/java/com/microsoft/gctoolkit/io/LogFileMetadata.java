...
public abstract class LogFileMetadata {
    ...
    private final GCLogFileFormat fileFormat;
    private final Path path;

    public LogFileMetadata(Path path) throws IOException {
        this.path = path;
        fileFormat = GCLogSources.formatOf(path);
    }
    ...
    public boolean isZip()  {
        return fileFormat == GCLogFileFormat.ZIP;
    }
    ...
    public boolean isGZip() {
        return fileFormat == GCLogFileFormat.GZIP;
    }
    ...
    public boolean isPlainText() {
        return fileFormat == GCLogFileFormat.PLAIN_TEXT;
    }
    ...
    public boolean isDirectory() {
        return fileFormat == GCLogFileFormat.DIRECTORY;
    }
