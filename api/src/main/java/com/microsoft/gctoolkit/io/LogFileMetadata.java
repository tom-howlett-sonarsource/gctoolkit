...
public abstract class LogFileMetadata {
    ...
    private GCLogSource.Format fileFormat = GCLogSource.Format.PLAIN_TEXT;
    ...
    GCLogSource.Format getFormat() {
        return fileFormat;
    }

    private void discoverFormat() {
        try {
            fileFormat = GCLogSource.discover(path);
        } catch (IOException ioe) {
            LOG.warning(ioe.getMessage());
            fileFormat = GCLogSource.Format.PLAIN_TEXT;
        }
    }
    ...
    public boolean isZip()  {
        return fileFormat == GCLogSource.Format.ZIP;
    }
    ...
    public boolean isGZip() {
        return fileFormat == GCLogSource.Format.GZIP;
    }
    ...
    public boolean isPlainText() {
        return fileFormat == GCLogSource.Format.PLAIN_TEXT;
    }
    ...
    public boolean isDirectory() {
        return fileFormat == GCLogSource.Format.DIRECTORY;
    }
