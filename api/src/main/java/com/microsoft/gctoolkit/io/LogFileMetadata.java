...
public abstract class LogFileMetadata {
    ...
    public LogFileMetadata(Path path) throws IOException {
        this.path = path;
        logSource = LogSource.discover(path);
    }
    ...
    public boolean isZip()  {
        return logSource.format() == LogSource.Format.ZIP;
    }
    ...
    public boolean isGZip() {
        return logSource.format() == LogSource.Format.GZIP;
    }
    ...
    public boolean isPlainText() {
        return logSource.format() == LogSource.Format.PLAIN_TEXT;
    }
    ...
    public boolean isDirectory() {
        return logSource.format() == LogSource.Format.DIRECTORY;
    }
