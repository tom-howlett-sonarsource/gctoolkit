...
import com.microsoft.gctoolkit.io.logsource.FileFormat;
import com.microsoft.gctoolkit.io.logsource.LogSourceHelper;
...
public abstract class LogFileMetadata {
    ...
    public LogFileMetadata(Path path) throws IOException {
        this.path = path;
        this.fileFormat = LogSourceHelper.detectFormat(path);
    }
